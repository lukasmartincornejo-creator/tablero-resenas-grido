...
def aplicar_estilo_grafico(fig):
    fig.update_layout(
        ...
        xaxis=dict(
            title=dict(text="Fecha", font=dict(color='#0f172a', size=14, family='Segoe UI')),
            tickfont=dict(color='#0f172a', size=12)
        ),
        yaxis=dict(
            title=dict(text="Cantidad de Reseñas", font=dict(color='#0f172a', size=14, family='Segoe UI')),
            tickfont=dict(color='#0f172a', size=12)
        ),
        legend=dict(
            title=dict(text="Sentimiento", font=dict(color='#0f172a', size=13, family='Segoe UI')),
