...
# ==========================================
st.set_page_config(page_title="Tablero Reseñas Grido", layout="wide")
st.title("📊 Tablero de Análisis de Reseñas - Grido")

# ==========================================
# 2. CONFIGURACIÓN Y EXTRACCIÓN (CON CACHÉ)
# ==========================================
...
with st.spinner("Cargando datos de Play Store..."):
    df = cargar_datos()
...
if not df_pos.empty:
    texto_pos = " ".join(review for review in df_pos.content.dropna().astype(str))
    if texto_pos.strip():
...
if not df_neg.empty:
    texto_neg = " ".join(review for review in df_neg.content.dropna().astype(str))
    if texto_neg.strip():
...
# ==========================================
# 5. EXPORTACIÓN Y DESCARGA NATIVA
# ==========================================
